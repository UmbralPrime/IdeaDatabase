    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmprId = table.Column<int>(type: "int", nullable: false)
                    ...
                    DetalleCNAE = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Teléfono2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Empresas", x => x.EmprId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CorrespondId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    EmprId = table.Column<int>(type: "int", nullable: false),
                    EmpresaEmprId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Correspondencias", x => x.CorrespondId);
                    table.ForeignKey(
                        name: "FK_Correspondencias_Empresas_EmpresaEmprId",
                        column: x => x.EmpresaEmprId,
                        principalSchema: "IdeaDatabase",
                        principalTable: "Empresas",
                        principalColumn: "EmprId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Correspondencias_EmpresaEmprId",
                schema: "IdeaDatabase",
                table: "Correspondencias",
                column: "EmpresaEmprId");
        }
